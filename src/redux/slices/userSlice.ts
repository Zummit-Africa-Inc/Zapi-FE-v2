...
export const getUserApis = createAsyncThunk(
  "user/getapis",
...
export const getSubscribedApis = createAsyncThunk(
  "user/getsubscribed",
  async (id: any, thunkAPI) => {
    const headers = {
      "X-Zapi-Auth-Token": `Bearer ${cookies.get("accessToken")}`,
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getUserProfile.pending, (state) => {
      ...
      builder.addCase(
        getUserApis.fulfilled,
        (state, action: PayloadAction<any>) => {
          state.userApis = action.payload;
        }
      );
    builder.addCase(
      getSubscribedApis.fulfilled,
      (state, action: PayloadAction<any>) => {
        state.subscribedApis = action.payload;
      }
    );
    builder.addCase(
      getSubscribedUsers.fulfilled,
      (state, action: PayloadAction<any>) => {
