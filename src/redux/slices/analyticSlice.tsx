...
export const getAnalyticsLog = createAsyncThunk(
  "analyticsLog/getAnalyticsLog",
  async (id: any, thunkAPI) => {
    ...
    try {
      const response = await fetch(
        `${core_url}/analytics/logs?page=1&limit=5&filter.apiId=${id}`,
        { headers }
      );
      const data = await response.json();
      return data.data;
