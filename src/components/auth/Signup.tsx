...
import { AuthLayout, Button, InputField, Paper, Spinner } from "../../components";
  ...
  return (
    <Box className={classes.container}>
        <form onSubmit={handleSubmit} className={classes.form}>
            <InputField label="Username" name="userName" type="text" {...bind} style={{background: currentMode === "dark" ? "#383838" : ""}} />
